...
for computing a $k$th order derivative of the ratio $p'{x}/p(x)$ for a black box univariate polynomial $p(x)$ -- given by a black box for its evaluation.
...
Our subject is a  novel efficient algorithm for the computation of ratio $p'{x}/p(x)$ for a black box univariate polynomial $p(x)$ -- given by a black box for its evaluation. This goal was
