...
\end{algorithmic}
\end{algorithm}
Alg. \ref{alg:DLG_rational_form} is a straightforward dynamic programming on Equation \ref{eqdndrt}. Therefore, by Thm.~\ref{thm:rat_root_correctness}, we have that Alg.~\ref{alg:DLG_rational_form} correctly computes Eq.~\ref{eqdndrt}.
